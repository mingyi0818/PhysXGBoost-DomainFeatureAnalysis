...
Ensure the dataset file is present at `data/bank_marketing.csv`.
...
4. Records test-set AUC, F1 for every configuration.
...
1. Open `results/summary.json` and verify the AUC, F1 values for Raw and Domain feature sets.
