# Reproduction Guide — 46_FlightDelay_PhysXGBoost
...
**Local path**: `data/bank_marketing.csv`
...
4. Records test-set AUC for every (model, feature_set, seed) triple.
...
ls results/additional_metrics_v2.json
```
...
|----------------|-------------|--------------|
| Abstract / Table | summary.json | Raw.*.AUC, F1, Domain.*.AUC, F1 |
