...
> A domain feature engineering approach for predicting online purchase intention using tree-based models. E-commerce-specific features (browsing patterns, pageview durations, special-day proximity) are systematically compared against raw features.

**Task**: Classification | **Target**: y (purchase intention: true/false) | **Primary Metric**: AUC
...
| Size | 1.07 MB |
| Source | UCI Machine Learning Repository - Online Shoppers Intention Dataset. ~12,330 sessions with 18 features covering page views, durations, bounce/exit rates, and special day indicators. |
| Task | Classification |
| Target | y (purchase intention: true/false) |
| Metric | AUC |
...
|--------|-----------|-------|
| AUC | XGBoost (Domain features) | AUC = 0.9244 |
