# Reproduction Guide: 49_Superconductor
...
**Dataset**: Superconductivity (UCI ML Repository)
...
**Local path**: `data/superconductor.csv`
...
Ensure the dataset file is present at `data/superconductor.csv`.
