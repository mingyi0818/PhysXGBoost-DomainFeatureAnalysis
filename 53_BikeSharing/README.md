...
> An urban mobility domain feature engineering approach for predicting bike sharing demand. Domain features capturing temporal patterns (rush hour, seasonal cycles), weather discomfort indices, and user behavior are compared against raw features across tree-based models.

**Task**: Regression | **Target**: cnt (total rental bikes count) | **Primary Metric**: R2

## Dataset

| Item | Detail |
|------|--------|
| Name | Bike Sharing (UCI ML Repository) |
| File | `data/bikesharing.csv` |
| Size | 0.92 MB |
| Source | UCI Machine Learning Repository - Bike Sharing Dataset. 17,379 hourly records with 13 features covering weather, season, holiday, and rental counts over 2 years. |
| Task | Regression |
| Target | cnt (total rental bikes count) |
| Metric | R2 |
...
|--------|-----------|-------|
| R2 | XGBoost (Domain features) | R2 = 0.9532 |
