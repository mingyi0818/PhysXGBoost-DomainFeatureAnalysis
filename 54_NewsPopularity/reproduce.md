...
Ensure the dataset file is present at `data/news_pop.csv`.
...
> NOTE: R2 scores are near zero across all models and feature sets, demonstrating the fundamental difficulty of news popularity prediction. This is a key finding of the paper (feature engineering futility), not an experimental error.
