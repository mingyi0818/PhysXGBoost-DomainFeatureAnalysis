# Reproduction Guide: 56_PowerConsumption
...
Ensure the dataset file is present at `data/power.csv`.
...
> NOTE: R2 scores exceed 0.999 for all models, which may indicate data leakage or temporal autocorrelation in the power consumption time series. This is investigated in the paper as a data leakage diagnosis case study.
