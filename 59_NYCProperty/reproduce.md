# Reproduction Guide: 59_NYCProperty
...
**Dataset**: NYC Property Sales (NYC Department of Finance)
...
**Local path**: `data/nyc_property_sales.csv`
...
Ensure the dataset file is present at `data/nyc_property_sales.csv`.
...
| `shap_and_saturation.json` | SHAP values and information-theoretic saturation bounds |
...
ls results/shap_and_saturation.json
```
