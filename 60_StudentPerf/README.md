...
> An educational domain feature engineering approach for predicting student academic performance. Domain features capturing study habits, family background, and social factors are compared against raw features across tree-based models.
...
| Size | 0.06 MB |
| Source | UCI Machine Learning Repository - Student Performance Dataset. 649 samples with 33 features covering demographics, family background, study habits, and grades from Portuguese schools (P. Cortez and A. Silva, 2008). |
| Task | Regression |
...
|--------|-----------|-------|
| R2 | CatBoost (Domain features) | R2 = 0.2843 |
