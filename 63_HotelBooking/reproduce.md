# Reproduction Guide: 63_HotelBooking
...
**Dataset**: Hotel Booking Demand (Kaggle / ScienceDirect)
...
Ensure the dataset file is present at `data/hotel.csv`.
